...
var placeRook = function(columnRow) {
  columnRow.forEach(function(square) {
    ...
    for (var i = 0; i < 8; i++) {
      ...
      if (columnReduce === 0) { // columnReduce === 0 means no rooks in the top row
    ...
    for (var i = 0; i < 8; i++) {
      ...
      if ( (columnReduce === 0) && (columnRow[0][i] + columnRow[0][i] === 0) ){
    ...
    for (var i = 0; i < 8; i++) {
      ...
      if ( (columnReduce === 0) && (columnRow[0][i] + columnRow[0][i] === 0) && (columnRow[1][i] + columnRow[1][i] === 0) ){
    ...
    for (var i = 0; i < 8; i++) {
      ...
      if ( (columnReduce === 0) && (columnRow[0][i] + columnRow[0][i] === 0) && (columnRow[1][i] + columnRow[1][i] === 0) && (columnRow[2][i] + columnRow[2][i] === 0) ){
    ...
    for (var i = 0; i < 8; i++) {
      ...
      if ( (columnReduce === 0) && (columnRow[0][i] + columnRow[0][i] === 0) && (columnRow[1][i] + columnRow[1][i] === 0) && (columnRow[2][i] + columnRow[2][i] === 0) && (columnRow[3][i] + columnRow[3][i] === 0) ){
    ...
    for (var i = 0; i < 8; i++) {
      ...
      if ( (columnReduce === 0) && (columnRow[0][i] + columnRow[0][i] === 0) && (columnRow[1][i] + columnRow[1][i] === 0) && (columnRow[2][i] + columnRow[2][i] === 0) && (columnRow[3][i] + columnRow[3][i] === 0) && (columnRow[4][i] + columnRow[4][i] === 0) ){
        columnRow[5][i] = true;
      };
    };
    ...
    for (var i = 0; i < 8; i++) {
      ...
      if ( (columnReduce === 0) && (columnRow[0][i] + columnRow[0][i] === 0) && (columnRow[1][i] + columnRow[1][i] === 0) && (columnRow[2][i] + columnRow[2][i] === 0) && (columnRow[3][i] + columnRow[3][i] === 0) && (columnRow[4][i] + columnRow[4][i] === 0) && (columnRow[5][i] + columnRow[5][i] === 0) ){
        columnRow[6][i] = true;
      };
    };
